...
// The maximum resolution allowed for the modeler window
#define MAX_RES 2500
...
private:
	...
	// for user defined resolution
	static bool userResolution;
	static int userWidth;
	static int userHeight;
	Fl_Window* resolutionBox;
	static Fl_Input *widthInput;
	static Fl_Input *heightInput;
	...
	inline void cb_setResolutionButton_i( Fl_Widget* o, void* v);
	static void cb_setResolutionButton( Fl_Widget* o, void* v);
	...
	inline void cb_setResolution_i(Fl_Menu_*, void*);
	static void cb_setResolution(Fl_Menu_*, void*);
