...
inline void ModelerUIWindows::cb_m_controlsAnimOnMenu_i(Fl_Menu_*, void*) {
	  bool a = (m_controlsAnimOnMenu->value() == 0) ? false : true;
	    ModelerApplication::Instance()->setAnimating(a);
}

void ModelerUIWindows::cb_m_controlsAnimOnMenu(Fl_Menu_* o, void* v) {
  ((ModelerUIWindows*)(o->parent()->user_data()))->cb_m_controlsAnimOnMenu_i(o,v);
}
...
Fl_Menu_Item ModelerUIWindows::menu_m_pmbMenuBar[] = {
 ...
 {"Set &Resolution...", 0,  0, 0, 128, 0, 0, 14, 0},
 ...
 {"Enable", 0,  (Fl_Callback*)ModelerUIWindows::cb_m_controlsAnimOnMenu, 0, 2, 0, 0, 14, 0},
 {0},
 {0}
};

Fl_Menu_Item* ModelerUIWindows::m_controlsAnimOnMenu = ModelerUIWindows::menu_m_pmbMenuBar + 19;
...
Fl_Menu_Item* ModelerUIWindows::m_pmiSetResolution = ModelerUIWindows::menu_m_pmbMenuBar + 5;
