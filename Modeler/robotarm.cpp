...
void base(float h) {
	setDiffuseColor( 0.25, 0.25, 0.25, 1 );
...
void rotation_base(float h) {
	setDiffuseColor( 0.85, 0.75, 0.25, 1 );
	...
	glPushMatrix();
		...
		glPopMatrix();
		setDiffuseColor( 0.15, 0.15, 0.65, 1 );
		...
		glPopMatrix();
		setDiffuseColor( 0.65, 0.65, 0.65, 1 );
...
void claw(float h) {
	setDiffuseColor( 0.25, 0.25, 0.85, 1 );
